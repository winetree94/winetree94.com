...
![](/content/articles/vector-optimizer/ko/image-1.png)

사용자가 원하는 결과는 점이 아니라 하나의 선일 것입니다. 그림을 완성하기 위해 이 점들을 직선으로 잇는다면 결과는 아래와 같이 표현됩니다.

![](/content/articles/vector-optimizer/ko/image-2.png)
...
![](/content/articles/vector-optimizer/ko/image-3.png)

그리고 이전 과정을 바탕으로 가장 최적화된 3차 베지어 곡선(Cubic Bézier Curve)을 찾아 최종적인 그림을 완성합니다. 완성된 그림은 다음과 같습니다.

![](/content/articles/vector-optimizer/ko/image-4.png)
