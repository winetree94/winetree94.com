...
test.describe("Language switching state retention", () => {
  test("maintains the current page when switching languages on a general page", async ({
    page,
  }) => {
  ...
  test("maintains the current page when switching languages on an article with translations", async ({
    page,
  }) => {
  ...
  test("redirects to index when switching to a language that doesn't have a translation for the current article", async ({
    page,
  }) => {
